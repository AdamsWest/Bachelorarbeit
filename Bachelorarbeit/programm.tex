...
Die wesentliche Zustandsgröße der Batterie ist der Entladestrom \ensuremath{I_{Bat}}. Dieser setzt sich aus den Motorströmen zusammen und zusätzlich dem Wirkungsgrad der Pulsweitenmodulation.
\begin{equation}
...
\end{equation}
berechnet sich die Restladung$_{i}$ nach der \ensuremath{i}-ten Flugphase. Diese ist vor allem für die erfliegbaren Grenzen interessant.


Bei Batterien, hier vor allem Li-Ion und Li-Po, ist die Batteriespannung abhängig von der Entladerate und der Zeit. Hierzu hat \cite{Tremblay.2009} ein einfaches Modell aufgestellt, in welchem dieser Zusammenhang berücksichtigt wird \textcolor{red}{Vgl. Abb. Blub}. 
\begin{center}
	\includegraphics[scale=0.2]{images/Coming-Soon.jpg}
\end{center}
