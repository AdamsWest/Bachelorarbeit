...
\subsubsection{Motor}
Die ersten drei Motorparameter sind notwendig, um die Motorspannung und den Motorstrom zu berechnen. Der letzte Parameter dient als technische Grenze, die für ein gut ausgelegtes System nicht überschritten wird. Die Motormasse fließt in Kombination mit der Anzahl der Propeller in die Gesamtmasse des Fluggerätes mit ein.
...
\includegraphics[scale=0.5]{images/TUBS_logo_inst_IFF.pdf}
...
\end{equation}
erreicht wird. 
Ist das Abbruchkriterium erreicht, kann der erforderliche Schub mit dem Satz des Pythagoras aus den Kräften in \(X_g-\) und \(Z_g-\)Richtung
\begin{equation}
...
\subsubsection{Flächenflugzeug}
Der Schub für ein Flächenflugzeug berechnet sich aus der Kompensation des Widerstandes und des Anteils der Gewichtskraft.
Aus dem Kräftegleichgewicht können folgende Beziehungen 
\begin{equation}
...
\subsubsection{Schub}
Der Schub wird innerhalb eines sehr einfachen Modells berechnet
...
Beruhend auf der Annahme eines idealen Rotors, Profilierung von \ensuremath{r = 0} bis \ensuremath{r = 1}, bleiben Blattspitzeneffekte, Blattwirbelinteraktionen, Strömungsablösungen usw. vernachlässigt. Zudem wird eine über den Radius konstante induzierte Geschwindigkeit in der Rotorebene angenommen. Dies ist im Vorwärtsflug und bei Schräganströmung zu relativieren. \textcolor{red}{van der Wall}
%\begin{itemize}
