...
\begin{figure}[H]
%\centering
	\includegraphics[scale=0.8]{Diagramme/Ausgangskonstellation.pdf}
...
Der \ensuremath{K_V}-Wert gibt die Anzahl der Umdrehungen pro Minute pro Volt im Leerlauf wieder. Ein hoher \ensuremath{K_V}-Wert bedeutet nun im Umkehrschluss, dass bei einer hohen Drehzahl die Spannung vergleichsweise geringer ist als für einen Motor mit niedrigem \ensuremath{K_V}-Wert. Gleichzeitig sinkt allerdings das Verhältnis von Drehmoment pro Ampere, das der \ensuremath{K_M}-ausdrückt  \cite[S.35 und S.42-43]{Buchi.2013}. Es gilt die Beziehung
\begin{equation}
	K_M = 1/K_V\cdot 30/\pi.
\end{equation}
Ein Motor mit hohem \ensuremath{K_V}-Wert muss daher einen hohen Dauermotorstrom besitzen, um gute Flugleistungen zu erzielen. 
\textcolor{red}{kleiner KV bedeutet PWM bei 100 schneller erreicht und damit auch schneller das erreichte Leistungsmaxima}
\\
...
\begin{figure}[H]
%\centering
	\includegraphics[scale=0.8]{Diagramme/Untersuchung_E.pdf}
