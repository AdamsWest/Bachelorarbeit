...
%    \tikzexternalenable
    ...
    \include{title_page_thesis}
%    \tikzexternaldisable
    %
    \includepdf[pages=-]{task_description} 			% Hier die Aufgabenstellung einfügen
    %
    % Einbinden des Eids.
    \include{oath}
    %
...
% ******************************************************************************
    ...
    \include{chapter_n}
    \include{programmbeschreibung}
    \include{nachbildung}
    \include{parameteruntersuchung}
    \include{conclusion}
