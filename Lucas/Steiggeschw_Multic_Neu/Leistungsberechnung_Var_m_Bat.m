...
subplot(521), plot(H,C_Rest_V*100,'LineWidth',2), title('Restladung'), 
    xlabel('Höhe [m]'),ylabel('C_{Bat,Rest} [%]') %, legend([l1], l1_Info)
subplot(522), plot(H,Omega/(2*pi)*60,'LineWidth',2), title('Drehzahl'), 
    xlabel('Höhe [m]'),ylabel('Drehzahl [RPM]') %, legend([l2], l2_Info)
subplot(523), plot(H,I_mot,'LineWidth',2), title('Motorstrom'), 
    xlabel('Höhe [m]'),ylabel('I_{Mot} [A]') %, legend([l3], l3_Info)
subplot(524), plot(H,U_mot,'LineWidth',2), title('Motorspannung'), 
    xlabel('Höhe [m]'),ylabel('U_{mot} [V]') %, legend([l4], l4_Info)
subplot(525), plot(H,I_Bat,'LineWidth',2), title('Batteriestrom'), 
    xlabel('Höhe [m]'),ylabel('I_{Bat} [%]') %, legend([l5], l5_Info)
H2 = [0;H];
subplot(526), plot(H2,U_Bat,'LineWidth',2), title('Batteriespannung'), 
    xlabel('Höhe [m]'),ylabel('U_{Bat} [A]') %, legend([l6], l6_Info)
subplot(527), plot(H,PWM*100,'LineWidth',2), title('Pulsweitenmodulation'), 
    xlabel('Höhe [m]'),ylabel('PWM [%]') %, legend([l7], l7_Info)
subplot(528), plot(H,eta_ges*100,'LineWidth',2), title('Gesamtwirkungsgrad'), 
    xlabel('Höhe [m]'),ylabel('eta_{ges} [%]') %, legend([l8], l8_Info)
subplot(529), plot(H,V_Kg,'LineWidth',2), title('Bahngeschwindigkeit'), 
    xlabel('Höhe [m]'),ylabel('V_{Kg} [m/s]') %, legend([l9], l9_Info)
