...
%       [Omega,tau] = Propeller(V_A, alpha, Thrust, RPM_map, V_map, T_map, TAU_map)
%       ermittelt aus einem gegebenen Propellerkennfeld die Drehzahl für 
%       einen benötigten Schub sowie das sich daraus ergebende Drehmoment 
