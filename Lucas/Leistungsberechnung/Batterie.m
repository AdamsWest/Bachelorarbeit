function [I_bat,C_rate,Delta_C_bat,C_Rest_V] = Batterie(PWM,eta_PWM,I_mot,n_Prop,C_bat,P_bat_peukert,Delta_C_bat,t_Flug)
...
C_bat_Peukert = C_bat * (1/C_rate)^(P_bat_peukert-1);               % nutzbare Kapazitaet nach Peukert
