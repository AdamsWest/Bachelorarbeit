...
%     m = m_copter + n_Prop_Quad*m_Mot_Quad + m_nutz + m_Bat;
    ...
    f_p = Abfrage_f_P(j);                                    % Penalty-Faktor für das Strukturgewicht des Flugzeugs
...
subplot(529), title('Bahnneigungswinkel'), xlabel('Höhe [m]'),
    ylabel('gamma [°]'), 
subplot(5,2,10), title('Bahngeschwindigkeit'), xlabel('Höhe [m]'),
    ylabel('V_{Kg} [m/s]'),    
