...
stairs(H,Omega_g/(2*pi)*60,'LineWidth',1), xlabel('Höhe [m]'),ylabel('Drehzahl [RPM]')
...
stairs(H,Uebersetzung,'LineWidth',1), title('Pitch'), grid, xlabel('Höhe [m]'),ylabel('Übersetzung i [-]')
