...
% Getriebe
ue_min = 0.2;           % minimale Übersetzung
ue_Delta = 0.05;         % Schrittweite der Über
ue_max = 5;            % maximale Übersetzung
...
Dateiname = ['Multicopter, m_Mot = ' num2str(m_Mot) ', n_Prop = ' num2str(n_Prop) ', K_V = ' num2str(K_V*60/(2*pi)) ', Prop = ' prop_name ...
    ', n_Bat_cell = ' num2str(N_Bat_cell) ', c_W = ' num2str(c_W_copter_oben) ', u_Wg = ' num2str(u_Wg) 'ms mit uebersetzung'];
