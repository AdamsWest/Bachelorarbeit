function [I_bat,C_rate,Delta_C_bat,C_Rest_V] = Batterie(PWM,eta_PWM,I_mot,n_Prop,C_bat,P_bat,Delta_C_bat,t_Flug,Eo,A,K,R,i_int,Q,Qexp)
...
i_int = I_bat*t_Flug + i_int;                              % Integral des Stroms
V_bat = Eo - R*I_bat - K * Q / (Q - i_int) * (i_int + I_bat*i_star) ...
    + A * exp(-B*i_int);                                    % Batteriespannung pro Zelle
V_bat = N_el * V_bat;                                       % gesamt Batteriespannung
