...
% Wie wird das Flugsystem geflogen? Wird entweder mit konstanter
% Bahngeschwindigkeit geflogen (V) oder mit vorgegebener Schubhebelstellung
% (PWM)

%Vorgabe = 'V';
%PWM_Profil = [67.5 75 82.5 90 95]/100;                  % PWM in Prozent, Profilverlauf über der Höhe

% Windgeschwindigkeiten in x-, y- und z-Richtung in m/s, 
